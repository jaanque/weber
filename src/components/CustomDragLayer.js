...
// Replicated from GeometricShape.js to avoid circular dependencies
...
const TextBoxPreview = ({ item }) => {
  const previewStyle = {
    ...
    ...item.style,
    transform: `rotate(${item.rotation || 0}deg)`, // Apply rotation
  };
...
const ShapePreview = ({ item }) => {
    ...
    return (
        <div style={previewStyle}>
            <svg width="100%" height="100%" preserveAspectRatio="none" style={{ overflow: 'visible', opacity: 0.7 }}>
